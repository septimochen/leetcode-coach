...
class Settings(BaseSettings):
    ...
    llm_api_key: SecretStr = Field(validation_alias=AliasChoices("LLM_API_KEY", "OPENAI_API_KEY"))
    ...
    llm_model: str = Field(default="gpt-5-mini", validation_alias=AliasChoices("LLM_MODEL", "OPENAI_MODEL"))
